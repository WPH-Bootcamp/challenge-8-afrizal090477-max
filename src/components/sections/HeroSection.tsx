...
const HeroSection = () => {
  ...
  return (
    <section
      id="hero"
      // 🎯 FIGMA SPEC: Minimal tinggi seksi dikunci di 747px mengikuti ukuran visual raksasanya
    ...
    >
      {/* 🎯 FIGMA SPEC: Padding kiri-kanan desktop dipatok 140px (lg:px-[140px]) biar sejajar lurus dengan navbar */}
      <Container className="max-w-[1440px] w-full px-6 md:px-12 lg:px-[140px] relative">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center relative z-10 w-full min-h-[747px]">
          ...
          {/* ==========================================================
              SISI KIRI: KONTEN TEKS & CTA (width: 653px, gap total: 40px)
              ========================================================== */}
          <div className="text-center lg:text-left flex flex-col gap-[40px] z-20 w-full lg:w-[653px] shrink-0 pt-10 lg:pt-0">
            
            {/* Pembungkus Judul & Subtitle (gap: 8px) */}
            <div className="w-full flex flex-col gap-[8px]">
              {/* Judul Utama (font-size: 56px, Bold 700, line-height matching display-3xl) */}
              <h1
              ...
              {/* Deskripsi Subtitle (SemiBold 600, text-xl) */}
            ...
            {/* BUTTON HEROLET'S TALK (width: 200px, height: 48px, inner-shadow) */}
          ...
          {/* ==========================================================
              SISI KANAN: VISUAL ILLUSTRATION 3D (747px x 747px, left: 696px)
              ========================================================== */}
          {/* Menggunakan lg:absolute dengan koordinat left-[696px] pas mengikuti blueprint figma */}
